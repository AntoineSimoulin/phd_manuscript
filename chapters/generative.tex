...
\bottomrule
\end{tabularx}}
\caption{\labtab{generative:lm-scores-2}Perplexity of our models. We train the $n$-gram model on the respective training set. The perplexity is directly measured on the test set which are identical for two benchmarks.}
\end{table}
