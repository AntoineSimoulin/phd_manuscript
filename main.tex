...
% \newcommand{\acomment}[2]{{\color{Green} #1} {\bfseries\color{blue} #2}}
...
\title[A study on sentences embeddings and their relation with sentence structure]{A study on sentences embeddings and their relation with sentence structure}
