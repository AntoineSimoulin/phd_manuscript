...
\begin{figure*}[htb!]
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=\columnwidth]{images/cosine-base-v4.png}
    ...
    \begin{subfigure}[b]{0.32\textwidth}  
        \centering 
        \includegraphics[width=\columnwidth]{images/cosine-small-v4.png}
    ...
    \begin{subfigure}[b]{0.32\textwidth}   
        \centering 
        \includegraphics[width=\columnwidth]{images/cosine-tiny-v4.png}
